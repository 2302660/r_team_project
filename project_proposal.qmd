...
```{r}
# Rename column names
colnames(breaches) <- c("organisation", "alternative name", "records_lost", "year", "date", "story", "sector", "method", "interesting story", "data_sensitivity", "records","nill", "source name", "source link", "source-1", "source-2", "id")
...
```{r}
# Necessary columns
breaches <- select(breaches, `organisation`,  `records_lost`, `year`, `date`, `story`, `sector`, `method`,  `data_sensitivity`, `source link`)
