---
title: "Visualizing World’s Biggest Data Breaches and Hacks Over Time (2004 - 2024)"
...
The improved visualization significantly enhances clarity and detail. It uses a bubble chart format, with bubble sizes corresponding to records lost and colors denoting breach methods, providing an intuitive understanding of data breach impacts and causes. The comprehensive legend and organized layout make the chart more aesthetically appealing and easier to interpret quickly and accurately compared to the original.

# Visualization (Interactive)

![This is an interactive bubble plot of the improved visualization.](./images/Interactive_Plot.png){width=100%}

This interactive plot allows users to explore data by hovering over bubbles for details, filtering by year and sector, and toggling between linear and logarithmic scales for records lost. The plot is color-coded by breach method, with a legend for reference, and users can click on bubbles to view detailed information about each breach.
