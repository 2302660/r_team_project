  ...
  set page(
    ...
    footer: [
      ...
      #block(
        ...
        radius: 10pt,
        [
          #text(font: "Courier", size: footer_url_font_size, fill: rgb(255, 255, 255), footer_url) 
          #h(1fr) 
          #text(size: footer_text_font_size, fill: rgb(255, 255, 255), footer_text) 
          #h(1fr) 
          #text(font: "Courier", size: footer_url_font_size, fill: rgb(255, 255, 255), footer_email_ids)
        ]
      )
    ]
  )
